...
import { Header, MessageCard, NewMessageButton, FilterTab, FilterChips, FilterModal, TabFooter } from '../../components';
...
import {filterMessages, type FilterState} from '../../utils/filterHelpers';
import {Funnel} from 'phosphor-react-native';

const Explore: React.FC<ScreenProps> = ({navigation}) => {
  const {colors} = useColors();
  const {user} = useAuth();
  const {messages: allMessages, isLoading: isLoadingMessages, error: memoryError} = usePublicMessages();
